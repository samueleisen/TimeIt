...
(() => {
  ...
  if (soundAlertsToggle) {
    ...
    soundAlertsToggle.addEventListener('change', async (e) => {
      ...
      if (soundAlertsEnabled) {
        unlockAudioContext();
        if (window.TimeItNotifications && window.TimeItNotifications.requestPermission) {
          await window.TimeItNotifications.requestPermission();
  ...
  addCountdownForm.addEventListener('submit', (e) => {
    ...
    if (window.TimeItNotifications && window.TimeItNotifications.scheduleAlarm) {
      window.TimeItNotifications.scheduleAlarm(newCountdown.id, newCountdown.title, newCountdown.targetTimestamp);
    }
  });
  ...
  function resetCountdown(id) {
    ...
    // Re-schedule native Android hardware alarm
    if (window.TimeItNotifications && window.TimeItNotifications.scheduleAlarm) {
      window.TimeItNotifications.scheduleAlarm(item.id, item.title, item.targetTimestamp);
    }
  }
  ...
  function deleteCountdown(id) {
    ...
    // Cancel native Android hardware alarm
    if (window.TimeItNotifications && window.TimeItNotifications.cancelAlarm) {
      window.TimeItNotifications.cancelAlarm(id);
    }
  }
